...
export default function Hero() {
  return (
    <section className="min-h-screen grid grid-cols-1 lg:grid-cols-2 relative overflow-hidden">
      ...
      <div className="flex flex-col justify-center pt-32 pb-16 px-8 lg:pt-32 lg:pb-16 lg:px-20 relative z-10 animate-slideUp">
        ...
        <Typography variant="h1" className="mb-2">
          ...
          <br />
          Nasrin
          <em className="italic font-light text-accent block mt-1">Shejuti</em>
        </Typography>
        <Typography
          variant="body2"
      ...
      <div className="hidden lg:flex relative z-0 items-center justify-center animate-fadeIn">
        <div className="relative w-[320px] h-100">
          ...
          <div
            ...
            style={{
              background: "linear-gradient(160deg, #4a9668, #3a7d52, #5aa070)",
              clipPath:
                "polygon(15% 0%, 100% 0%, 100% 80%, 85% 100%, 0% 100%, 0% 20%)",
            }}
          >
            <Image
              src="https://rubayanasrin.com/storage/profiles/Lvwfzbt2Hp6cmu97VVkOOxo7PgbZA3krejqN8VnU.jpg"
              alt="Rubaya Nasrin"
              width={320}
              height={400}
