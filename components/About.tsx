    ...
    >
      <div className="reveal">
        ...
        <Typography variant="subtitle1" className="mb-[1.2rem]">
          ...
          government-linked research institutions, I bring a cross-disciplinary
          lens to challenges at the frontlines of the climate crisis —
          particularly in climate-vulnerable South Asian contexts.
        </Typography>
